...
import '/pages/Guide/Guidedetails/Errors.dart';
import '/pages/Guide/Guidedetails/Fat.dart';
import '/pages/Guide/Guidedetails/arm.dart';
import '/pages/Guide/Guidedetails/dite.dart';
import '/pages/Guide/Guidedetails/tribiceps.dart';
import '/pages/Guide/Guidedetails/Vatimens.dart';
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Padding(
                              padding:
                                  const EdgeInsets.only(left: 25, top: 8.0),
                              child: Text(
                                "Check for update",
                                style: TextStyle(
                                  color: Colors.white,
